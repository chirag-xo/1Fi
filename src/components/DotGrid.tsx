...
const DotGrid = ({
    ...
    const ObjectRef = useRef<any>(null); // Prevents TS issues with window object if needed
        ...
        const onMove = (e: MouseEvent) => {
            ...
            for (const dot of dotsRef.current) {
                ...
                if (speed > speedTrigger && dist < proximity && !dot._inertiaApplied) {
                    ...
                    // Fallback simpler push animation (InertiaPlugin requires a paid GSAP membership)
                    const pushX = dot.cx - pr.x + vx * 0.05;
